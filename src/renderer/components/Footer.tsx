...
export function Footer({ deviceName, version = '1.0.0', variant = 'simple' }: FooterProps) {
  if (variant === 'detailed') {
    // 桌面端样式：显示设备名和版本号
    return (
      <div className="flex-shrink-0 px-6 pt-3 pb-4 border-t border-white/5 bg-transparent">
  ...
  // 网页端样式：居中显示应用名和版本
  return (
    <div className="px-4 py-3 text-center border-t border-divider bg-background">
