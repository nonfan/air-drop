...
export function Logo({ className = 'w-5 h-5', showText = true, textClassName = 'text-sm font-semibold tracking-tight' }: LogoProps) {
  return (
    <>
      <svg
        className={className}
      ...
      {showText && <span className={textClassName}>Airdrop</span>}
    </>
  );
}
